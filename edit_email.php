...
<body>
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h1 class="bold text-muted text-center mt-5">Edit Data Staff</h1>
      </div>
    </div>
        ...
        <table class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <form action="form_edit.php" method="post">
              <input type="text" hidden name="nip" value="<?php echo "$data[Nip]" ?>">
              <button type="submit" name="submit" class="ml-5 center btn btn-primary" value="Edit"><i class="fas fa-edit"></i></button>
            </form>
            <?php
              echo "</td>";
              echo "</tr>";
